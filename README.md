...
Your primary objective is to accurately classify the provided clinical input into disease labels with high probabilities. The clinical input you will receive is as follows:
